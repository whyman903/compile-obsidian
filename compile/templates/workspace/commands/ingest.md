...
8. For each theme identified in Phase A:
   - If an article or map already covers it, treat that page as the anchor. Update only that anchor page and ensure a `[[wikilink]]` connects the source note and the article/map.
